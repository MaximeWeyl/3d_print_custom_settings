...
G1 X0 Y0 Z100 F5000                          ; move up off last probe point
G4 S1                                       ; pause
M400                                        ; wait for moves to finish
M117 Heating...                             ; progress indicator message on LCD
M190 R{material_bed_temperature_layer_0}    ; wait for bed to reach printing temp
M109 R{material_print_temperature_layer_0}  ; wait for extruder to reach printing temp
G1 Z2 E0 F1000                                ; prime tiny bit of filament into the nozzle
; G12 ; wipe again
G1 X0 Y0 Z100 F5000                          ; move up so you can manually wipe it one more time
G4 S2                                       ; pause so you can wipe
